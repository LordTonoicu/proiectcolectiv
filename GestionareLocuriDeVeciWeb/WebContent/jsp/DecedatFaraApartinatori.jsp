...
<%@ page import="dto.*" %>
	...
	<jsp:useBean id="listDecedatiFaraApartinatori" class="java.util.ArrayList" scope="session"/>
	<jsp:setProperty name="listDecedatiFaraApartinatori" property="*"/> 
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                       ...
                                       <%
										int i=0;
  										for (Object dece:listDecedatiFaraApartinatori) {
  											DecedatFaraApartinatoriDTO decedat = (DecedatFaraApartinatoriDTO) dece;
  											i++;
       								 %> 
