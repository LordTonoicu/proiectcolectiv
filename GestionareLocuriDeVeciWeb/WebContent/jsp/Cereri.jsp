				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							Gestioneaza cereri <a
								href="JavaScript:newPopup('addCerere.html')">
								<button class="btn btn-primary" type="button"
									style="float: right; margin-top: -7px; margin-right: 10px">
									<img src="css/plus.png"> Adauga cerere

								</button> <a href="JavaScript:newPopup('updateCerere.html')">
									<button class="btn btn-primary" type="button"
										style="float: right; margin-top: -7px; margin-right: 10px">
										<img src="css/plus.png"> Actualizeaza cerere
								...
								<button class="btn btn-primary" type="button"
									style="float: right; margin-top: -7px; margin-right: 10px">
									<img src="css/plus.png"> Sterge cerere
