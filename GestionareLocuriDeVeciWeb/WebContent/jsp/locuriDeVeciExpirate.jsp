...
<body onload="getById()">
	...
	<jsp:useBean id="listLocuriDeVeciExpirate" class="java.util.ArrayList" scope="session"/>
	<jsp:setProperty name="listLocuriDeVeciExpirate" property="*"/> 
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <%
                                        int i=0;
  										for (Object lvObject:listLocuriDeVeciExpirate) {
