    ...
    <div id="wrapper">
       ...
       <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Vizualizare</h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Cereri
                           <a href="raspuns.html"> <button class="btn btn-primary" type="button" style="float:right;margin-top:-7px;margin-right:10px">
                                    Intocmeste raspuns

                            </button>
                            </a>
                             <button class="btn btn-primary" type="button" style="float:right;margin-top:-7px;margin-right:10px">
                                    Atribuie loc de veci
