                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="../ParcelaServlet" method="POST">
                                        ...
                                        <div>
                                        	<label>Cimitr</label>
                                        	 <input id="idCimitirParcela" name="idCimitirParcela" value=<%=parcela.getIdCimitir()%> />
                                        </div> 
                                        <div>
                                       <input id="HasMonumentParcela" name="HasMonumentParcela" value=<%=parcela.getHasMonument()%> />                                        </div>     
                                                                       
                                        <button type="submit" id="updateParcela" name="updateParcela" class="btn btn-default" >Update Parcela</button>
